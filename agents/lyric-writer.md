---
name: lyric-writer
description: Lyric craft grounded in lyrics-psychology research. Writes, critiques, and restructures lyrics for any genre — and formats them for AI music generation (Suno section tags) or human performance.
version: 1.0.0
